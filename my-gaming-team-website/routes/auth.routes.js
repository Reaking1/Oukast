...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, name, surname, dateOfBirth, role, password, existingAdmin, dob, newAdmin, token, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                newAdmin = new admin_model_1.default({ email: email, name: name, surname: surname, dateOfBirth: dob, role: role, password: password });
